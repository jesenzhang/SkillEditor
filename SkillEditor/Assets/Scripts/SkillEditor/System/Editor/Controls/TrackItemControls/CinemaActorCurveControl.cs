...
[CutsceneItemControlAttribute(typeof(ActorClipCurve))]
public class CinemaActorCurveControl : CinemaCurveControl
{
    ...
    {
        ActorClipCurve clipCurve = Wrapper.Behaviour as ActorClipCurve;
    ...
    {
        ActorClipCurve arg = userData as ActorClipCurve;
        arg.showInScene = !arg.showInScene;
    }
    protected override void showContextMenu(Behaviour behaviour)
    {
        ActorClipCurve clipCurve = behaviour as ActorClipCurve;
        if (clipCurve == null) return;
        ...
        if (clipCurve.Actor != null)
        {
            ...
            createMenu.AddItem(new GUIContent(clipCurve.showInScene?"HideInScene":"ShowInScene"), false, showInScene, clipCurve);
    ...
    {
        public ActorClipCurve clipCurve;
