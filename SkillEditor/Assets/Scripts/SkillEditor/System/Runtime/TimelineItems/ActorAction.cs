...
namespace TimeLine
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    public abstract class ActorAction : TimelineAction
    {
        public virtual Transform Actor()
        {
            if (TimelineTrack is ActorItemTrack)
            {
                ActorItemTrack t = (ActorItemTrack)TimelineTrack;
                return t.Actor;
            }
            else
                return null;
        ...
        {
            TimelineAction otherAction = (TimelineAction)other;
        ...
        {
            get { return ((this.TimelineTrack == null) ? null : this.TimelineTrack.Manager); }
        }
    }
}