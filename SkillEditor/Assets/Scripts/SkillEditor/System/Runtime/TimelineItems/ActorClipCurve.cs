...
namespace TimeLine
{
    [Serializable, TimelineItemAttribute("Curve Clip", "Actor Curve Clip", TrackItemGenre.CurveClipItem)]
    public class ActorClipCurve : ItemClipCurve, IRevertable
    {
        ...
        public override TimelineManager Manager
        {
          get { return TimelineTrack.Manager; }
        }
